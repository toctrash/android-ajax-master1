...
import iut.projet_android.util.SystemUiHider;
...
public class FullscreenActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Picasso.with(this).load(getIntent().getExtras().getString(Intent.EXTRA_TEXT)).into(imgFullscreen);
		
		// Set Dummy button behavior on click :)
